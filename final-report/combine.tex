...
In informal terms, we are confident in the quality of direct comparisons, if they can be observed, and not very confident in the prediction of the model. Results for Beta-Binomal model is presented below. 
...
\begin{tabular}{|l|cc|cc|cc|}
	...
	\hline
	% 
	BCS          & 00.0\% & 0.00 & 93.0\%  &  0.85 \\
	Turk         & 00.0\% & 0.00 & 75.0\%  &  0.62 \\
	Turk no-tie  & 00.0\% & 0.00 & 82.0\%  &  0.63 \\
	Mohit        & 00.0\% & 0.00 & 75.0\%  &  0.61 \\
	Mohit no-tie & 00.0\% & 0.00 & 76.0\%  &  0.53 \\
	% 
	\hline
\end{tabular}
\caption{\label{font-table}. Results for the two best models combined with pointwise estimation baseline using Beta-Binomial model.}
\end{table}
